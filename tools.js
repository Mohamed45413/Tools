function t(diffInSeconds) {
  let seconds = diffInSeconds % 60;
  diffInSeconds = Math.floor(diffInSeconds / 60);
  let minutes = diffInSeconds % 60;
  diffInSeconds = Math.floor(diffInSeconds / 60);
  let hours = diffInSeconds % 24;
  diffInSeconds = Math.floor(diffInSeconds / 24);
  let year = Math.floor(diffInSeconds / 365);
  let days = Math.floor(diffInSeconds % 365.25);
  return {
    year,
